...
| 標的維持・解除・切替 | 死亡・保護・同種除外、距離超過24 step、score/距離差による再評価。診断専用consensusは通常OFF | actual Pack supportを使う通常挙動はなかった | 共有targetだけ54 step以内の短期保持。support終了、48 step進展なし、無効化、距離超過で解除。明確に有利な候補には切替可能 |
